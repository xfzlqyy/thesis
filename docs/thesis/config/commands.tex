...
\newcommand{\checkedbox}{\makebox[0pt][l]{\hspace{0.2ex}\raisebox{0.2ex}{\scalebox{0.7}{\ensuremath{\checkmark}}}}\ensuremath{\square}}

% Insert one explicit blank back side for duplex printing.
...
% Ensure the next content starts on a right-hand (odd) page.
